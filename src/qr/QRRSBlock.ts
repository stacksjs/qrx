...
export default class QRRSBlock {
  ...
  static RS_BLOCK_TABLE: RsBlockTable = [
    // L
    // M
    // Q
    // H
  ...
  static getRsBlockTable(typeNumber: number, errorCorrectLevel: any): any {
    switch (errorCorrectLevel) {
      case QRErrorCorrectLevel.L:
        return this.RS_BLOCK_TABLE[(typeNumber - 1) * 4]
