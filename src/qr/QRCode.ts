...
export class QRCode {
  ...
  createMovieClip(targetMc: any, instanceName: any, depth: any): any {
  ...
  static createCanvas(options: Partial<QRCodeOptions>): HTMLCanvasElement {
    const opt: QRCodeOptions = {
      width: 256,
      height: 256,
  ...
  static setCanvas(id: string, options: Partial<QRCodeOptions>): void {
